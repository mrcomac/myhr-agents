...
https://github.com/strands-agents/docs/blob/main/docs/examples/deploy_to_eks/README.md
## Introduction
...
Call the cv evaluation endpoint
```
curl -X POST \
  http://localhost:8080/cv-evaluation \
  -H 'Content-Type: application/json' \
  -d '{"prompt": "evaluate this CV: path:"}'
```
